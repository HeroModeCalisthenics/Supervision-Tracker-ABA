...
create table if not exists public.fieldwork_entries (
  ...
  supervised_hours numeric(6,2) not null default 0 check (supervised_hours >= 0),
  individual_supervision_hours numeric(6,2) not null default 0 check (individual_supervision_hours >= 0),
  group_supervision_hours numeric(6,2) not null default 0 check (group_supervision_hours >= 0),
